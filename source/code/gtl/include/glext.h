...
/************************************************************************
 * NOTE:
 * This file (glext.h version 16, 2002/07/18) has been modified by
 * Marcus Geelnard to add the following support:
 *  - OpenGL 1.4
 *  - ARB_vertex_program
...
GLAPI void APIENTRY glMultiDrawElements( GLenum mode, GLsizei *count, GLenum type, const GLvoid **indices, GLsizei primcount );
GLAPI void APIENTRY glPointParameterf( GLenum pname, GLfloat param );
GLAPI void APIENTRY glPointParameterfv( GLenum pname, GLfloat *params );
...
#ifdef GL_GLEXT_PROTOTYPES
GLAPI void glVertexAttrib1sARB (GLuint index, GLshort x);
GLAPI void glVertexAttrib1fARB (GLuint index, GLfloat x);
GLAPI void glVertexAttrib1dARB (GLuint index, GLdouble x);
GLAPI void glVertexAttrib2sARB (GLuint index, GLshort x, GLshort y);
GLAPI void glVertexAttrib2fARB (GLuint index, GLfloat x, GLfloat y);
GLAPI void glVertexAttrib2dARB (GLuint index, GLdouble x, GLdouble y);
GLAPI void glVertexAttrib3sARB (GLuint index, GLshort x, GLshort y, GLshort z);
GLAPI void glVertexAttrib3fARB (GLuint index, GLfloat x, GLfloat y, GLfloat z);
GLAPI void glVertexAttrib3dARB (GLuint index, GLdouble x, GLdouble y, GLdouble z);
GLAPI void glVertexAttrib4sARB (GLuint index, GLshort x, GLshort y, GLshort z, GLshort w);
GLAPI void glVertexAttrib4fARB (GLuint index, GLfloat x, GLfloat y, GLfloat z, GLfloat w);
GLAPI void glVertexAttrib4dARB (GLuint index, GLdouble x, GLdouble y, GLdouble z, GLdouble w);
GLAPI void glVertexAttrib4NubARB (GLuint index, GLubyte x, GLubyte y, GLubyte z, GLubyte w);
GLAPI void glVertexAttrib1svARB (GLuint index, const GLshort *v);
GLAPI void glVertexAttrib1fvARB (GLuint index, const GLfloat *v);
GLAPI void glVertexAttrib1dvARB (GLuint index, const GLdouble *v);
GLAPI void glVertexAttrib2svARB (GLuint index, const GLshort *v);
GLAPI void glVertexAttrib2fvARB (GLuint index, const GLfloat *v);
GLAPI void glVertexAttrib2dvARB (GLuint index, const GLdouble *v);
GLAPI void glVertexAttrib3svARB (GLuint index, const GLshort *v);
GLAPI void glVertexAttrib3fvARB (GLuint index, const GLfloat *v);
GLAPI void glVertexAttrib3dvARB (GLuint index, const GLdouble *v);
GLAPI void glVertexAttrib4bvARB (GLuint index, const GLbyte *v);
GLAPI void glVertexAttrib4svARB (GLuint index, const GLshort *v);
GLAPI void glVertexAttrib4ivARB (GLuint index, const GLint *v);
GLAPI void glVertexAttrib4ubvARB (GLuint index, const GLubyte *v);
GLAPI void glVertexAttrib4usvARB (GLuint index, const GLushort *v);
GLAPI void glVertexAttrib4uivARB (GLuint index, const GLuint *v);
GLAPI void glVertexAttrib4fvARB (GLuint index, const GLfloat *v);
GLAPI void glVertexAttrib4dvARB (GLuint index, const GLdouble *v);
GLAPI void glVertexAttrib4NbvARB (GLuint index, const GLbyte *v);
GLAPI void glVertexAttrib4NsvARB (GLuint index, const GLshort *v);
GLAPI void glVertexAttrib4NivARB (GLuint index, const GLint *v);
GLAPI void glVertexAttrib4NubvARB (GLuint index, const GLubyte *v);
GLAPI void glVertexAttrib4NusvARB (GLuint index, const GLushort *v);
GLAPI void glVertexAttrib4NuivARB (GLuint index, const GLuint *v);
GLAPI void glVertexAttribPointerARB (GLuint index, GLint size, GLenum type, GLboolean normalized, GLsizei stride, const GLvoid *pointer);
GLAPI void glEnableVertexAttribArrayARB (GLuint index);
GLAPI void glDisableVertexAttribArrayARB (GLuint index);
GLAPI void glProgramStringARB (GLenum target, GLenum format, GLsizei len, const GLvoid *string);
GLAPI void glBindProgramARB (GLenum target, GLuint program);
GLAPI void glDeleteProgramsARB (GLsizei n, const GLuint *programs);
GLAPI void glGenProgramsARB (GLsizei n, GLuint *programs);
GLAPI void glProgramEnvParameter4dARB (GLenum target, GLuint index, GLdouble x, GLdouble y, GLdouble z, GLdouble w);
GLAPI void glProgramEnvParameter4dvARB (GLenum target, GLuint index, const GLdouble *params);
GLAPI void glProgramEnvParameter4fARB (GLenum target, GLuint index, GLfloat x, GLfloat y, GLfloat z, GLfloat w);
GLAPI void glProgramEnvParameter4fvARB (GLenum target, GLuint index, const GLfloat *params);
GLAPI void glProgramLocalParameter4dARB (GLenum target, GLuint index, GLdouble x, GLdouble y, GLdouble z, GLdouble w);
GLAPI void glProgramLocalParameter4dvARB (GLenum target, GLuint index, const GLdouble *params);
GLAPI void glProgramLocalParameter4fARB (GLenum target, GLuint index, GLfloat x, GLfloat y, GLfloat z, GLfloat w);
GLAPI void glProgramLocalParameter4fvARB (GLenum target, GLuint index, const GLfloat *params);
GLAPI void glGetProgramEnvParameterdvARB (GLenum target, GLuint index, GLdouble *params);
GLAPI void glGetProgramEnvParameterfvARB (GLenum target, GLuint index, GLfloat *params);
GLAPI void glGetProgramLocalParameterdvARB (GLenum target, GLuint index, GLdouble *params);
GLAPI void glGetProgramLocalParameterfvARB (GLenum target, GLuint index, GLfloat *params);
GLAPI void glGetProgramivARB (GLenum target, GLenum pname, GLint *params);
GLAPI void glGetProgramStringARB (GLenum target, GLenum pname, GLvoid *string);
GLAPI void glGetVertexAttribdvARB (GLuint index, GLenum pname, GLdouble *params);
GLAPI void glGetVertexAttribfvARB (GLuint index, GLenum pname, GLfloat *params);
GLAPI void glGetVertexAttribivARB (GLuint index, GLenum pname, GLint *params);
GLAPI void glGetVertexAttribPointervARB (GLuint index, GLenum pname, GLvoid **pointer);
GLAPI GLboolean glIsProgramARB (GLuint program);
#endif /* GL_GLEXT_PROTOTYPES */
